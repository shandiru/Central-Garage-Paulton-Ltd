...
const services = [
  {
    title: "Mot testing",
    desc: "Ensure your vehicle meets legal safety and emissions standards with our comprehensive MOT testing service.",
  ...
  {
    title: "Diagnostics",
    desc: "Identify and fix issues quickly with our advanced vehicle diagnostics, keeping your car running smoothly.",
    image: "/tyres.avif",
...

  {
    ...
    desc: "Restore your alloy wheels to like-new condition with professional refurbishment services.",
    image: "/valeting.avif",
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-15 mx-auto h-25 "
                    onError={(e) => {
