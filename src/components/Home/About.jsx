...
const AboutSection = () => {
  ...
  const testimonials = [
{
    text: "I hired a LWB van from this garage a couple of days ago. The van was in excellent condition and drove extremely well. I would personally like to thank Allan and Michael for their friendly and professional services. They are indeed a credit to this company.",
    name: "Stuart King."
  },
